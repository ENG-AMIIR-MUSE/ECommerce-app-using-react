...
const  AddProduct = ()=>{
  const [image,setImage]  = useState(null)
    ...
    return(
        ...
        <div  className="bg-gray-900 mt-0  p-10  text-black  min-h-screen flex flex-col lg:flex-row lg:max-w-full 2xl:max-w-full max-w-sm mx-auto justify-center items-center  shadow-lg rounded-lg  overflow-hidden">
