...
const  AddProduct = ()=>{
  const [image,setImage]  = useState(null)
    ...
    return(
        ...
        <div  className="bg-gray-900 mt-0  text-black  min-h-screen flex flex-col lg:flex-row lg:max-w-2xl 2xl:max-full max-w-sm mx-auto justify-center items-center  shadow-lg rounded-lg  overflow-hidden">
