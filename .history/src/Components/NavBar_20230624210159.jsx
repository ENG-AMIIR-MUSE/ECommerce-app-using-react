...
import {Link } from 'react-router-dom'
 export function NavBar() {
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    <div className="text-sm lg:flex-grow flex space-x-2 justify-center">
      ...
      <Link to="/addProducts" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
        AddProduct
      </Link>
    </div>
