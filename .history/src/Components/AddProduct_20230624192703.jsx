    ...
    return(
        ...
        <div  className="bg-gray-900 mt-0  text-black  min-h-screen flex flex-col max-w-sm mx-auto justify-center items-center  shadow-lg rounded-lg ">
          ...
          <form className="space-y-3">
           ...
           <input type="text"placeholder="Product Name" className="w-full  rounded-lg h-11 placeholder:text-red-900 pl-3"/>
          <input type="text"placeholder="Product Product Price" className="w-full rounded-lg h-11 "/>
          <input type="text"placeholder="Product Description" className="w-full rounded-lg h-11 "/>
