...
const  AddProduct = ()=>{
  const [image,setImage]  = useState(null)
    ...
    return(
        ...
        <div  className="bg-gray-900 mt-0  text-black  min-h-screen flex flex-col lg:flex-row lg:max-w-2xl  max-w-sm mx-auto justify-center items-center  shadow-lg rounded-lg  overflow-hidden">
          <div className="w-96 rounded-lg mx-auto  bg-red-900  m-5 h-80 p-10">
           <img src= {reactsvg}  alt="missing-product-image"/>
          </div>
          <div className=" p-10 m-10 rounded-lg bg-red-100 mx-auto bg-green-50 mx-auto">
          <form className="space-y-3 mx-auto bg-blue-900 ml-0">
          
           <input type="text"placeholder="m-20 Product Name" className="w-full rounded-lg h-11  pl-3"/>
