...
//   console.log(products.id)
    ...
    return(
        <div className=' m-auto overflow-hidden  w-[80%] rounded-lg border  border-red-900 sm:w-1/3 md:w-1/4 h-[400px]'>
         <div className=' w-full  h-[230px]'>
         <img src={products.image} alt='adfadlfj'/>
         </div>
         {/* <div className='flex  justify-end p-2 mb-10 pb-10 h-[300px] bg-red-900'>
