...
const  AddProduct = ()=>{
    ...
    return(
        ...
        <div  className="bg-gray-900 mt-0  text-black  min-h-screen flex flex-col lg:flex-row max-w- max-w-sm mx-auto justify-center items-center  shadow-lg rounded-lg ">
          <div>
