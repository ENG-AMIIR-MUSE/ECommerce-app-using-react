...
const  AddProduct = ()=>{
    ...
    return(
        ...
        <div  className="bg-gray-900 mt-0 w-auto text-black  min-h-screen flex flex-col lg:flex-row lg:max-w-2xl  max-w-sm mx-auto justify-center items-center  shadow-lg rounded-lg ">
          ...
          <input type="text"placeholder="Product Description" className="w-full rounded-lg h-11  pl-3"/>
           ...
           <div className="flex felx-row items-center justify-center space-x-4">
             <img src={reactsvg} alt="" className="rounded-full w-52 h-52 mt-5  max-w-md  object-cover object-center bg-yellow-900" />
             <input type="file" className = "rounded-lg p-3 h-10 "/>
